...
export default function BookingAccountPage () {
    ...
    const renderActions = (booking: ReadBookingUser) => {
        ...
        switch (currentStatus) {
            case "pending":
                return (
                    <div className="flex gap-2">
                        ...
                        <button className="px-2 py-1 text-xs font-bold bg-green-600 text-white rounded hover:bg-green-700 transition cursor-pointer uppercase">
                            Thanh toán
                        </button>
                    </div>
                );
            ...
            case "cancelled":
                return (
                    <button className="px-3 py-1 text-xs font-bold bg-orange-500 text-white rounded hover:bg-orange-600 transition cursor-pointer uppercase">
                        Đặt lại
                    </button>
                );
            default:
        ...
        <div className="flex flex-col gap-2 w-full max-w-full overflow-x-hidden">
            ...
            <div className="py-2 w-full flex flex-col">
                <div className="w-full px-2">
                    ...
                    {/* table section - Đây là phần xử lý scroll ngang */}
                    <div className="bg-white rounded-xl border border-gray-300 overflow-hidden shadow-sm">
                        <div className="overflow-x-auto"> {/* Thẻ bọc để tạo thanh cuộn riêng cho table */}
