...
interface CancelPaymentBonusProps {
    isOpen: boolean;
    onClose: () => void;
    booking_id: string;
    onSuccess: () => void;
...
export default function CancelPaymentBonusPage ({isOpen, onClose, booking_id, onSuccess}: CancelPaymentBonusProps) {
    ...
    const handleCancel = async () => {
        ...
        try {
            const res = await fetch(
                `${API_URL}/payment/admin/cancel-payment-bonus/${paymentData?.payment_id}`,
                {
                    method: "PUT",
                    credentials: "include",
                    headers: {
                            ...
                            <div className="flex flex-col flex-1">
                                <div className="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg min-h-[300px]"
                                        disabled={loading}
                                    />
                                </div>
