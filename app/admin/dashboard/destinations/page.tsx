...
export default function DestinationsPage () {
    ...
    const filteredAndSorted = useMemo(() => { //lưu kết quả xử lý từ dữ liệu API, không cần gọi lại
        ...
        if (search.trim()) {
            ...
            result = result.filter(des =>
                ...
                des.region.toLowerCase().includes(term) ||
                des.country.toLowerCase().includes(term) ||
        ...
        return result;
    }, [destinations, search, sortBy, sortOrder]);
    ...
    //sort
    const handleSort = (field: keyof destinationInfo) => {
        if (sortBy === field) {
    ...
    return (
        <div className="py-2 max-w-7xl mx-auto h-screen relative">
            <div className="w-full max-w-[96%] mx-auto">
                {/* title */}
                <h1 className="text-3xl font-bold mb-2 text-main">Quản lý điểm đến</h1>
                            ...
                            <thead className="bg-gray-50 border-b">
                                <tr>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Điểm đến
                                            <SortIcon isActive={sortBy === "name"} direction={sortBy === "name" ? sortOrder : null} />
                                        </div>
                                    </th>
                                    <th 
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Đất nước
                                            <SortIcon isActive={sortBy === "country"} direction={sortBy === "country" ? sortOrder : null} />
                                        </div>
                                    </th>
                                    <th 
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Vùng miền
                                            <SortIcon isActive={sortBy === "region"} direction={sortBy === "region" ? sortOrder : null} />
                                        </div>
                                    </th>
                                    <th 
