...
interface CancelBookingDepositProps {
    isOpen: boolean;
    onClose: () => void;
    booking_id: string;
    onSuccess: () => void;
...
export default function CancelBookingDepositPage ({isOpen, onClose, booking_id, onSuccess}: CancelBookingDepositProps) {
    ...
    const handleCancel = async () => {
        ...
        try {
            const res = await fetch(
                `${API_URL}/booking/admin/cancel-booking-deposit/${booking_id}`,
                {
                    method: "PUT",
                    credentials: "include",
                    headers: {
