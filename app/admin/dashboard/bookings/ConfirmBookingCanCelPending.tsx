...
interface ConfirmBookingCancelPendingProps {
    isOpen: boolean;
    onClose: () => void;
    booking_id: string;
    onSuccess: () => void;
...
export default function ConfirmBookingCancelPending ({isOpen, onClose, booking_id, onSuccess}: ConfirmBookingCancelPendingProps) {
    ...
    const handleCancel = async () => {
        ...
        try {
            ...
            const res = await fetch(
                `${API_URL}/booking/admin/confirm-booking-cancel-pending-and-refund/${booking_id}`,
                {
                    method: "PATCH",
                    credentials: "include",
                    body: formData,
