...
import { GeneralStatics } from "@/app/types/statics";
    ...
    return (
        <div className="max-w-7xl mx-auto min-h-screen">
            <div className="w-full mx-auto">
                ...
                {/* Revenue Chart */}
                <div className="bg-white rounded-lg shadow-md p-6">
                    <h2 className="text-2xl font-bold mb-6 text-gray-800">Biểu đồ doanh thu</h2>
                    ...
                    {revenueData.length > 0 && periodType !== 'custom' && (
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t-2">
                            <div className="text-center p-4 bg-green-50 rounded-lg">
                                <p className="text-sm text-gray-600 mb-2 font-medium">Tổng hoàn thành</p>
                                <p className="text-2xl font-bold text-green-600">
                                    {formatPrice(revenueData.reduce((sum, d) => sum + d.completed, 0))}
                                </p>
                            </div>
                            <div className="text-center p-4 bg-red-50 rounded-lg">
                                <p className="text-sm text-gray-600 mb-2 font-medium">Tổng hoàn trả</p>
                                <p className="text-2xl font-bold text-red-600">
                                    {formatPrice(revenueData.reduce((sum, d) => sum + d.refunded, 0))}
                                </p>
                            </div>
                            <div className="text-center p-4 bg-blue-50 rounded-lg">
                                <p className="text-sm text-gray-600 mb-2 font-medium">Tổng doanh thu ròng</p>
                                <p className="text-2xl font-bold text-blue-600">
